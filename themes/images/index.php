...
$sql3 = "SELECT * FROM book_read WHERE user_id = '$user_id' and book_id = $book_id";
												...
												<li class="span3">
													...
													<br>
														...
														<p class="price"><?php echo $book_author ?></p>
															...
															<a href="product_detail.php?id=<?php echo $our_id ?>"><button class="btn btn-inverse">  READ BOOK</button></a><br>
